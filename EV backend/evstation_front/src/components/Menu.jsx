...
import {
  FaBars, FaHome, FaChargingStation,
  FaClipboardList, FaUser, FaCommentDots,
  FaSignOutAlt, FaBell,
  FaInfoCircle
} from "react-icons/fa"
...
const Menu = () => {
  ...
  return (
    <>
      ...
      {/* SIDEBAR */}
      <div className={`fixed top-0 left-0 h-full w-64 bg-[#02141C] text-white transform transition-transform duration-300 z-50
